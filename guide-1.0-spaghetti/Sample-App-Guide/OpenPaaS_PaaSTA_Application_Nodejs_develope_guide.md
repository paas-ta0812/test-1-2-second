...
![./images/nodejs/2-2-1-0.png](./images/nodejs/2-2-1-0.png)

##### 2. Node.js 설치

- 다운받은 폴더에서 node-v0.12.4-x64.msi를 더블클릭하여 설치를 시작한다.

![./images/nodejs/2-2-1-1.png](./images/nodejs/2-2-1-1.png)

- "실행"버튼을 클릭하여 계속 진행한다.

![./images/nodejs/2-2-1-2.png](./images/nodejs/2-2-1-2.png)

- "Next"버튼을 클릭하a여 계속 진행한다.

![./images/nodejs/2-2-1-3.png](./images/nodejs/2-2-1-3.png)

- "I accept the terms in the License Agreement"를 체크하여 라이센스에 동의한 후 "Next"버튼을 클릭하여 계속 진행한다.

![./images/nodejs/2-2-1-4.png](./images/nodejs/2-2-1-4.png)

- 설치경로를 입력 혹은 선택한 후 "Next"버튼을 클릭하여 계속 진행한다.
여기서는 C:\Program Files\nodejs\ 를 설치경로로 설정하였다.

![./images/nodejs/2-2-1-5.png](./images/nodejs/2-2-1-5.png)

- 설치할 항목을 선택한 후 "Next"버튼을 클릭하여 계속 진행한다.
여기서는 선택하여 Node.js, npm, doc을 설치하고 환경변수 PATH까지 추가하였다.

![./images/nodejs/2-2-1-6.png](./images/nodejs/2-2-1-6.png)

- "Install"버튼을 클릭하여 설치한다.

![./images/nodejs/2-2-1-7.png](./images/nodejs/2-2-1-7.png)

- "Finish"버튼을 클릭하여 설치를 완료한다.

![./images/nodejs/2-2-1-8.png](./images/nodejs/2-2-1-8.png)

- '윈도우키+R' 또는 '시작->실행'아이콘을 클릭하여 실행창을 띄운 후 'cmd'를 입력하고 "확인"버튼을 눌러 커맨드창을 연다.

![./images/nodejs/2-2-1-9.png](./images/nodejs/2-2-1-9.png)

- 커맨드창에 아래의 명령어를 입력하여 node.js와 npm의 버젼과 제대로 설치되었는지 여부를 확인한다.

><div>>node -v
><div>>npm -v
![./images/nodejs/2-2-1-10.png](./images/nodejs/2-2-1-10.png)
...
![./images/nodejs/2-3-1-0.png](./images/nodejs/./images/nodejs/2-3-1-0.png)

- Express 애플리케이션을 생성한다. '-e'옵션은 view enjine을 ejs를 사용한다는 것이고 default view enjin은 jade이다.

><div>>.\node_modules\.bin\express -e
![./images/nodejs/2-3-1-1.png](./images/nodejs/./images/nodejs/2-3-1-1.png)
...
><div>>npm install
![./images/nodejs/2-3-1-2.png](./images/nodejs/./images/nodejs/2-3-1-2.png)
...
><div>>npm start
><div>>node bin/www
![./images/nodejs/2-3-1-3.png](./images/nodejs/./images/nodejs/2-3-1-3.png)

- 브라우저로 아래의 주소로 접속하여 애플리케이션이 제대로 동작하는지 확인한다.

><div>http://localhost:3000/
![./images/nodejs/2-3-1-4.png](./images/nodejs/./images/nodejs/2-3-1-4.png)
...
![./images/nodejs/2-3-3-0.png](./images/nodejs/2-3-2-0.png)

##### 3. Node.js 샘플 애플리케이션 디렉토리구조

![./images/nodejs/2-3-2-1.png](./images/nodejs/2-3-2-1.png)
...
![./images/nodejs/2-4-1-0.png](./images/nodejs/2-4-1-0.png)
...
![./images/nodejs/2-4-2-0.png](./images/nodejs/2-4-2-0.png)
...
![./images/nodejs/2-4-3-0.png](./images/nodejs/2-4-3-0.png)
...
![./images/nodejs/2-4-4-0.png](./images/nodejs/2-4-4-0.png)

연결확인

><div>$ cf services
![./images/nodejs/2-4-4-1.png](./images/nodejs/2-4-4-1.png)
...
![./images/nodejs/2-4-5-0.png](./images/nodejs/2-4-5-0.png)
...
><div>$ make test
![./images/nodejs/2-5-0-0.png](./images/nodejs/2-5-0-0.png)
